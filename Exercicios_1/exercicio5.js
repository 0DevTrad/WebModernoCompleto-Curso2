/*
    ...
    para mostrar dinheiro sempre da forma correta. Desenvolva uma função JavaScript para que 
    ela receba um valor como 0.30000000000000004 e retorne R$0,30 (observe a vírgula e o ponto).
*/

function converterParaDinheiro(valor) {
    const abreviacao = valor.toFixed(2)
    const dinheiro = abreviacao.replace('.', ',')
    return `R$ ${dinheiro}`
}

console.log(converterParaDinheiro(0.1 + 0.2)) // R$ 0,30